...
export const treleighData = {
  ...
  stats: [
    ...
    { icon: "palmtree", label: "Close to the Beach" },
    { icon: "dog", label: "Pets Welcome" },
    { icon: "flame", label: "Woodburner" },
    { icon: "sparkles", label: "Sauna" },
    { icon: "fence", label: "Balcony" },
  ...
  atAGlance: [
    ...
    [
      ...
      "Large veranda and expansive balcony",
      "One dog permitted",
    ],
  ],
  ...
  galleryImages: [
    ...
    "https://images.unsplash.com/photo-1616137466211-f736a1cc7845?w=1200&q=80",
    "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=1200&q=80",
    "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=1200&q=80",
    "https://images.unsplash.com/photo-1484154218962-a197022b5858?w=1200&q=80",
    "https://images.unsplash.com/photo-1600210492493-0946911123ea?w=1200&q=80",
    "https://images.unsplash.com/photo-1613977257363-707ba9348227?w=1200&q=80",
    "https://images.unsplash.com/photo-1600566753086-00f18f6b6370?w=1200&q=80",
  ...
  facilities: {
    downstairs: [
      ...
      "Fully equipped kitchen with dishwasher, oven, induction hob",
      "Nespresso coffee machine and bean-to-cup grinder",
      "Freestanding wood-burning stove",
      "50\" Smart TV with Netflix, Amazon Prime",
      "Sonos sound system throughout",
      "Utility room with washing machine and tumble dryer",
      "Guest WC",
    ],
    upstairs: [
      "Principal bedroom: king-size bed, en-suite with freestanding copper bath and walk-in shower, sea views",
      "Bedroom 2: king-size bed, en-suite shower room, sea views",
      "Bedroom 3: twin beds (can be zip-linked to super-king), shared bathroom",
      "Bedroom 4: bunk beds (suitable for children), shared bathroom",
      "Family bathroom with bath and overhead shower",
    ],
    outside: [
      "Expansive balcony with outdoor dining for 10",
      "Lower terrace with barrel sauna",
      "Heated outdoor shower",
      "Direct coastal path access via garden gate",
      "BBQ (Weber gas)",
      "Outdoor furniture and sun loungers",
      "Enclosed garden (suitable for dogs)",
      "One allocated parking space (5-minute walk)",
    ],
    pleaseNote: [
      ...
      "Short breaks available outside peak season",
      "Parking is a 5-minute walk from the property due to the coastal path setting",
    ],
  },
  ...
  activitiesText: [
    ...
    `Our editor's blog on the area shares her favourite ways to spend your time.`,
  ],

  reviewImage: "https://images.unsplash.com/photo-1416331108676-a22ccb276e35?w=800&q=80",
  reviewQuote: "We have stayed at Treleigh on every visit and we are blown away by its beautiful location.",
  reviewBody: "From the moment we arrived, the views took our breath away. The house itself is stunning — beautifully designed, incredibly well-equipped, and with that rare quality of feeling both luxurious and completely relaxing. The sauna after a long coastal walk was absolute heaven. We've already booked our return.",
  reviewAttribution: "Ben & Claire - July 25",
  ...
  relatedProperties: [
    {
      ...
      name: "Porthmeor Retreat",
      location: "Padstow",
      tagline: "Contemporary coastal living with harbour views",
      sleeps: 6, beds: 3, baths: 2, price: 1450,
    },
    {
      images: [
        "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=600&q=80",
        "https://images.unsplash.com/photo-1600573472592-401b489a3cdc?w=600&q=80",
        "https://images.unsplash.com/photo-1616137466211-f736a1cc7845?w=600&q=80",
      ],
      name: "Harbour View",
      location: "Falmouth",
      tagline: "A grand family home overlooking the harbour",
      sleeps: 10, beds: 5, baths: 4, price: 2200,
    },
    {
      images: [
      ...
      name: "Sea View House",
      location: "St Ives",
      tagline: "Sweeping views from Porthminster to Godrevy",
      sleeps: 8, beds: 4, baths: 3, price: 1950,
    },
  ],
};

import type { JournalCategoryKey } from "@/data/journalData";

export type JournalChipKey = "all" | JournalCategoryKey;

interface JournalCategoryChipsProps {
  active: JournalChipKey;
  onChange: (next: JournalChipKey) => void;
}

const CHIPS: { key: JournalChipKey; label: string }[] = [
  { key: "all", label: "ALL" },
  { key: "destination-guides", label: "DESTINATION GUIDES" },
  { key: "seasonal", label: "SEASONAL" },
  { key: "food-drink", label: "FOOD & DRINK" },
  { key: "things-to-do", label: "THINGS TO DO" },
  { key: "for-families", label: "FOR FAMILIES" },
  { key: "travel-planning", label: "TRAVEL & PLANNING" },
];

const JournalCategoryChips = ({ active, onChange }: JournalCategoryChipsProps) => (
...
export default JournalCategoryChips;

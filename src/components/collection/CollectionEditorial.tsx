...
// Inline-bold renderer for **keyword** spans (matches DestinationEditorial)
...
const CollectionEditorial = ({ eyebrow, heading, paragraphs, pullQuote }: CollectionEditorialProps) => {
      ...
      >
        ...
        {pullQuote && (
          <div
            ...
            style={{ maxWidth: 480, marginTop: 40, marginBottom: 24 }}
          >
            <div style={{ width: 80, height: 1, background: "#d3a36e", marginBottom: 20 }} />
            <blockquote
              style={{
...
export default CollectionEditorial;

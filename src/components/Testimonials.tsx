      ...
      <div className="pc-container text-center">
        ...
        <div className="mt-14 max-w-[720px] mx-auto">
          ...
          <div className="flex justify-center mb-8">
            <svg width="80" height="80" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity: 0.5 }}>
          ...
          <p className="text-white italic leading-relaxed" style={{ fontSize: "clamp(24px, 2.2vw, 28px)", fontWeight: 300, lineHeight: 1.6 }}>
            "{t.quote}"
          </p>
          <p
          ...
          <p className="text-white/40 mt-2" style={{ fontSize: 11, textTransform: "uppercase", letterSpacing: 3 }}>
            {t.since}
          </p>
        </div>
